...
function Refranes(){
score=0
oculto.innerHTML = `A palabras necias oidos... <br></br>
...
function resultados(){
    oculto.innerHTML = `Tu puntaje es ${score}
    <button onClick="jugar()"> Comenzar Nuevamente </button>
    <button onClick="jugar()"> Cambiar Categoria </button>`
}
function desafioMusical(){
    score=0
    oculto.innerHTML = `Si no supieste amar... <br></br>
